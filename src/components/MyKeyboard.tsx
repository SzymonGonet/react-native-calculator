...
export default function MyKeyboard() {
  ...
  const getResult = () => {
    switch (operation) {
      case "%":
        clear();
        setResult((parseInt(secondNumber) * parseFloat(firstNumber)) / 100);
        break;
      case "+":
        clear();
    ...
    <View style={Styles.viewBottom}>
      ...
      >
        <Text style={Styles.screenSecondNumber}>
          {secondNumber}
          <Text style={{ color: "#f4ab44", fontSize: 50, fontWeight: "300" }}>
            {operation}
          </Text>
        </Text>
        {firstNumberDisplay()}
      ...
      <View style={Styles.row}>
        ...
        <Button title="×" isOrange onPress={() => handleOperationPress("x")} />
      </View>
      <View style={Styles.row}>
